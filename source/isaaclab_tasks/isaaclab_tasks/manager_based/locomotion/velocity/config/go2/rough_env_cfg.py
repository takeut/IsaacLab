...
class UnitreeGo2RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.feet_air_time.params["threshold"] = 0.75  # しきい値を上げて足をより高く上げるよう促す
        self.rewards.feet_clearance.params["threshold"] = 0.08  # しきい値を上げて足をより高く上げるよう促す
        ...
        self.commands.base_velocity.ranges.lin_vel_x = (-1.0, 1.0)  # 後ろ向き歩行を有効化
        self.commands.base_velocity.ranges.lin_vel_y = (-0.5, 0.5)  # 右向き歩行を有効化
